...
# ذلك ملفٌّ في `app/` لا يُقرأ للطفل.
#
# **وأثقلُها هنا الأولى**: صورُ الرصيد السمعيّ (`METHOD.md §٢`: «كلُّ كلمةٍ بحقلها
# الدلاليّ ومحطتها وصورتها — Twemoji **بصدق الصورة**») تُكتب في `curriculum.js`
# الجلسةَ ١، فتُجرد من هناك وحدَها ولا تُكتب قائمةُ ملفاتٍ بيد.
SOURCES = [
