...
const ASK = {
  word: 'اِسْمَعْ وَالْمَسِ الصُّورَةَ الَّتِي سَمِعْتَ',
  same: 'اِسْمَعِ الصَّوْتَيْنِ: أَهُمَا سَوَاءٌ أَمْ مُخْتَلِفَانِ؟',
  model: 'اُنْظُرْ وَاسْمَعْ — صَوْتَانِ مُتَقَارِبَانِ',
