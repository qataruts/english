...
const ASK = {
  first: 'اِسْمَعِ الصَّوْتَ وَالْمَسْ مَا يَبْدَأُ بِهِ',
  blend: 'اِسْمَعِ الْأَصْوَاتَ وَاجْمَعْهَا — أَيَّةُ صُورَةٍ هِيَ؟',
  segment: 'اِسْمَعِ الْكَلِمَةَ ثُمَّ الْمَسْ أَصْوَاتَهَا بِتَرْتِيبِهَا',
  rhyme: 'اِسْمَعْ وَالْمَسْ مَا يُشْبِهُ آخِرَهُ',
  model: 'اُنْظُرْ وَاسْمَعْ — الْمُعَلِّمُ يُسْمِعُ الْأَصْوَات',
};
