 ...
 * لا من نيّة المولّد: فما يراه الطفلُ ويسمعه هو المحكومُ عليه. ولا رمزَ ولا شائكةَ في
 * مسار السمع — مسارُ الحرف لم يُفتَح بعد (ق٤).
 */
export const usedOf = (round) => ({
  words: [...new Set([...(round.figures || []).map((f) => f.word), ...(round.saying || [])])]
    .filter(Boolean),
