...
const ASK = {
  pick: 'اسْمَعِ الْأَمْرَ وَالْمَسْ',
  put: 'اسْمَعِ الْأَمْرَ وَضَعِ التُّفَّاحَة',
  act: 'اسْمَعِ الْأَمْرَ وَاخْتَرْ مَنْ يَفْعَلُهُ',
  model: 'انْظُرْ: الْمُعَلِّمُ يَأْمُرُ وَيَفْعَل',
  // **الترديدُ في TPR فعلٌ لا قول** (`METHOD.md §١٢-٥`: يُدعى ولا يُقاس)
  doIt: 'افْعَلْهَا مَعَهُ',
};
