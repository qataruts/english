...
function dashboard(rerender = () => {}) {
  ...
  return h('div', { class: 'screen', css: { '--accent': ACCENT } },
    ...
    /* **وسطرُ النسخة في الصدر لا في الذيل** (بلاغُ الميدان ٦ — لفظُ المالك: «اين
       اجد اسم النسخة… فلا اراها هناك»): كان آخرَ سطرٍ تحت فقراتٍ طوال، فلا يُرى
       إلا بعد تمرير الصفحة كلِّها — **وهو أوّلُ ما يُسأل عنه يومَ ميدان** (أيّ
       نسخةٍ على الجهاز؟ `METHOD.md §١٢-١٠`). فصار تحت الشريط مباشرةً. */
    versionLine(),
    main,
  );
}
